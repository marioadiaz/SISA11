class Queja < ApplicationRecord
  ...
  RECLAMOS = ["R1-malo el servicio","R2-impuntualidad del técnico","R3-cancelación del servicio por el técnico","R4-irrespetuoso - mala atención","R5-falta de informacion administración-técnico","R6-técnico cansado estresado"]
